"""
YOLOv8x fulldata at imgsz=1280. For multi-model WBF ensemble with the 1536 models.
Different resolution = different errors = better ensemble.
"""
import json
import shutil
