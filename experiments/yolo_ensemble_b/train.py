"""
YOLOv8x with different seed + LR for ensemble diversity.
Train on 80/20 split so we can evaluate. Ensemble with the baseline model.
"""
import json
import shutil
...
if __name__ == "__main__":
    ...
    model.train(
        ...
        project="runs",
        name=NAME,
        seed=123,  # different seed from baseline (0)
        optimizer="AdamW",
        lr0=0.0008,  # slightly different LR
        weight_decay=0.0005,
