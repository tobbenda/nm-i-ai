"""
YOLOv8x trained on ALL 248 images, v2: more epochs + close_mosaic=15.
"""
import json
import shutil
...
def coco_to_yolo():
    ...
    val_imgs = all_images[-5:]  # tiny val just to avoid errors
    ...
    print(f"Dataset: {len(all_images)} train, {len(val_imgs)} val, {nc} classes")
